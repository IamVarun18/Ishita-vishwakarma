    ...
    <div className="h-screen p-10 gap-[10%] bg-pink flex items-center justify-center">
      <div className="flex flex-col gap-5 basis-2/3">
        ...
        <p className="px-8 text-xl">
          ...
          I&apos;ve performed Lata Mangeshkar Ji&apos;s classics across countries
          like London, Canada, Dubai, and more.
        </p>
        <p className="px-8 text-xl">
          My achievements include collaborating with Arijit Singh in Pyar Hai Toh Hai (2023),
          becoming a Brand Ambassador for Lado Abhiyan, and receiving the prestigious DHRUV Tara award.
          Music is my passion, and I&apos;m grateful to share it worldwide.
        </p>
      </div>
