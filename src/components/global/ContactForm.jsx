...
const ContactForm = () => {
  ...
  return (
    <div className='relative lg:h-screen h-[160vh] lg:flex-row flex flex-col-reverse lg:flex justify-center items-center bg-white'>
      <div className='px-[5%]'>
        <div className='lg:grid lg:grid-cols-3 gap-20'>
          ...
          <div className='col-span-1'>
            <div className='flex flex-col'>
              ...
              <p className='mt-4 text-xl font-semibold text-textpink'>
                For Shows:
              </p>
              <p className='text-lg'>
                <a
                  href='mailto:ishitaonstage@gmail.com'
                  className='text-black hover:underline'
                >
                  ishitaonstage@gmail.com
                </a>
              </p>

              <p className='mt-4 text-xl font-semibold text-textpink'>
                For Collaborations and More:
              </p>
              <p className='text-lg'>
                <a
                  href='mailto:singer.ishita.official@gmail.com'
                  className='text-black hover:underline'
                >
                  singer.ishita.official@gmail.com
                </a>
              </p>
            </div>
          </div>
