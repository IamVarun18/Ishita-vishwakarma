      ...
      <div className="w-full max-w-[62vw] mx-auto ">
        ...
        <div className="mb-10">
          <div className="flex items-start justify-between ">
            <button className="bg-red border-1 border-red text-white text-base font-semibold py-[9px] px-14 rounded-md">All Music</button>
            <button className="border-2 border-red text-red text-base font-semibold py-2 px-14  rounded-md">Vocals</button>
            <button className="border-2 border-red text-red text-base font-semibold py-2 px-14  rounded-md">Lyrics</button>
            <button className="border-2 border-red text-red text-base font-semibold py-2 px-14  rounded-md">Composition</button>
            <button className="border-2 border-red text-red text-base font-semibold py-2 px-14  rounded-md">Vocal Choir</button>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          {songs.map((song, index) => (
            <div key={index} className="bg-pink p-4 rounded-md grid grid-cols-10 items-center gap-2">
              <h3 className="text-base font-semibold col-span-2">{song.title}</h3>
